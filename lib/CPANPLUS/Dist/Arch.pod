...
B<CPANPLUS::Dist::Arch> - CPANPLUS backend for building Archlinux pacman packages
...
you are having trouble running C<setupdistarch> or C<cpan>, your PATH
...
included in the examples folder for an example.
