...
I<5.10.0> represents the version of perl you used to build the package
and I<~/.cpanplus> represents the base directory chosen in your CPANPLUS
config.

=over 4

=item Build Directory - C<~/.cpanplus/5.10.0/pacman/build>

=item Package Directory - C<~/.cpanplus/5.10.0/pacman/pkg>
...
the command line using the I<--dist-opts> switch.
