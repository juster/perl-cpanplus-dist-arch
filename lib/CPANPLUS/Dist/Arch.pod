...
After C<dist_type> is set, CPANPLUS will automatically package
anything you install using C<cpanp>.  Score!  You could then package
and install the DBIx::Class module like so:
